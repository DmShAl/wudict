...
rem ============================================================
rem wuDict Android FOSS build: [debug|release] [intel]
rem
...
echo.
echo ============================================================
echo wuDict Android %APK_ABI% build
echo ============================================================
echo.
...
rem The APK file name carries the same sanitized version as build.gradle's
rem apkVersion: no leading "v", no "/" (change both or neither).
set "APK_VERSION=%VERSION%"
if "%APK_VERSION:~0,1%"=="v" set "APK_VERSION=%APK_VERSION:~1%"
set "APK_VERSION=%APK_VERSION:/=_%"
...
echo ============================================================
echo Building wuDict FOSS %BUILD_TYPE% APK
echo ============================================================
echo.
...
set "APK=android\app\build\outputs\apk\foss\%BUILD_TYPE%\wudict-android-%APK_ABI%-foss%APK_SUFFIX%-%APK_VERSION%.apk"
